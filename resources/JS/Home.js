...
function addItem(article_name , article_link ){
    ...
    link.src = article_link;
    link.sandbox = "allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-top-navigation";
    link.width = "95%" ;
    link.height = "600px" ;
    ...
    article.appendChild(document.createTextNode(article_name))
